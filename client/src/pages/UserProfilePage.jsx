      ...
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="max-w-4xl w-full bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mt-4">{ user?.name}
          ...
          <div className="grid grid-cols-3 gap-4 mt-8">
            ...
            <div className="flex flex-col items-center">
              <span className="text-xl font-bold text-gray-800">5.6k</span>
              <span className="text-gray-600">Totol Pay</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-xl font-bold text-gray-800">400</span>
